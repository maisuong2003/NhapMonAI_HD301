...
public class Node implements Comparable<Node> {
	...
	private Node parent; // for printing the path(đường dẫn) from the start node to goal node
	private double pathCost;// from the root node to this node
	private int depth;// used for compute the depth of a node in a tree search-DFS
	private List<Edge> children = new ArrayList<Edge>();//danh sách các nút con của nút
    ...
    //trả về danh sách các nút con của nút
